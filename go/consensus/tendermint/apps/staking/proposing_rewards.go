...
func (app *stakingApplication) rewardBlockProposing(
	...
	proposerAcctID := staking.NewIDFromPublicKey(*proposingEntity)
	...
	if err = stakeState.AddRewardSingleAttenuated(ctx, epoch, &params.RewardFactorBlockProposed, numSigningEntities, numEligibleValidators, proposerAcctID); err != nil {
