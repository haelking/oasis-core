...
var (
	// RuntimeParamsDummy is a dummy instance of runtimeImpl used to register e2e/runtime/* parameters.
...
func (sc *runtimeImpl) Fixture() (*oasis.NetworkFixture, error) {
	...
	iasMock, err := sc.flags.GetBool(cfgIasMock)
	if err != nil {
		return nil, err
	}
...
func (sc *runtimeImpl) resolveRuntimeBinary(runtimeBinary string) (string, error) {
	...
	rtBinDir, err := sc.flags.GetString(cfgRuntimeBinaryDir)
	if err != nil {
		return "", err
	}
