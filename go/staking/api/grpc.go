...
func (c *stakingClient) Accounts(ctx context.Context, height int64) ([]ID, error) {
	var rsp []ID
...
func (c *stakingClient) Delegations(ctx context.Context, query *OwnerQuery) (map[ID]*Delegation, error) {
	var rsp map[ID]*Delegation
...
func (c *stakingClient) DebondingDelegations(ctx context.Context, query *OwnerQuery) (map[ID][]*DebondingDelegation, error) {
	var rsp map[ID][]*DebondingDelegation
